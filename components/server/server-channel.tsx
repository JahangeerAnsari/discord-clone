...
const ServerChannel: React.FC<ServerChannelProps> = ({
  ...
  "
      ...
      <p
        className={cn(
          "line-clamp-1 font-semibold text-sm text-zinc-500 group-hover:text-zinc-600dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
     ...
     "
      ...
      {channel.name === "general" && (
        <Lock className="ml-auto w-4 h4 text-zinc-600 dark:text-zinc-400" />
      )}
    </button>
  );
};
