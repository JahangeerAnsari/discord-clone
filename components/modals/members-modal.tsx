...
const MembersModal = () => {
  ...
  const onDeleteUser = async (memberId:string) =>{
    try {
  ...
  const onRoleChanged = async (memberId: string, role: MemberRole) => {
    try {
      ...
      router.refresh();
      // on open update the server data
      // jav response aai api se tab update data show kari
      onOpen("members", {server:response.data})
    } catch (error: any) {
                  ...
                  <div className="ml-auto">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent side="left">
                          ...
                          <DropdownMenuPortal>
                            <DropdownMenuSubContent>
                              ...
                              <DropdownMenuItem onClick={() =>onRoleChanged(member.id, "MODERATOR")}>
                                <ShieldCheck className="h-4 w-4 text-blue-700 mr-2" />
                                Moderator
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={() =>onDeleteUser(member.id)}>
